...
Il existe plusieurs appels système et fonctions de la librairie standard qui permettent de parcourir le système de fichiers. Les principaux sont :
 ...
 - les appels système `chmod(2)`_ et `chown(2)`_ permettent de modifier respectivement le mode (i.e. les permissions), le propriétaire et le groupe associés à un fichier. Les commandes `chmod(1)`_, `chown(1)`_ et `chgrp(1)`_ permettent de faire de même depuis le shell.
